...
This is the modern default for team projects. We cover the configuration depth in Module 10 (Pipeline as Code), but it's worth knowing now that you typically wire SCM up *once*, at the multibranch level, instead of repeating it per branch.
